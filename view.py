...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../Pictures/Computer Science icons/power.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Computer_Science_icons/volume_mute.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.tv_output.setGeometry(QtCore.QRect(340, 120, 311, 201))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        self.tv_output.setFont(font)
        self.tv_output.setFocusPolicy(QtCore.Qt.ClickFocus)
        ...
        self.volume_output.setGeometry(QtCore.QRect(410, 280, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setItalic(False)
        self.volume_output.setFont(font)
        self.volume_output.setAutoFillBackground(False)
        ...
        self.mute_output = QtWidgets.QLabel(self.centralwidget)
        self.mute_output.setGeometry(QtCore.QRect(370, 280, 31, 31))
        self.mute_output.setText("")
        self.mute_output.setPixmap(QtGui.QPixmap("Computer_Science_icons/Very_Black_screen.jpg"))
        self.mute_output.setScaledContents(True)
        self.mute_output.setObjectName("mute_output")
